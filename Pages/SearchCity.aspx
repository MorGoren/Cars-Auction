<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="SearchCity.aspx.cs" Inherits="Pages_SearchCity" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table class="auto-style1">
        ...
        <tr>
            <td>
                <asp:GridView ID="CarTable" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="ID" DataSourceID="ConnectionToCity" ForeColor="#333333" GridLines="None" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" Width="785px" AllowPaging="True" AllowSorting="True" CssClass="auto-style8">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="PIC" SortExpression="PIC" ></asp:BoundField>
                ...
                <asp:SqlDataSource ID="ConnectionToCity" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [ID], [TYPE], [YEAR], [HAND], [PIC], [BEGINPRICE], [FDATE] FROM [CARS] WHERE ([CITY] = @CITY)">
                    <SelectParameters>

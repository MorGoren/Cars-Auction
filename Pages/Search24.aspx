<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Search24.aspx.cs" Inherits="Pages_Search24" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table class="auto-style1">
        ...
        <tr>
            <td>
                <asp:GridView ID="CarTable" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="ID" DataSourceID="ConnectionToDate" ForeColor="#333333" GridLines="None" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" Width="785px" AllowPaging="True" AllowSorting="True" CssClass="auto-style8">
                ...
                <asp:SqlDataSource ID="ConnectionToDate" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [ID], [TYPE], [YEAR], [HAND], [PIC], [BEGINPRICE] FROM [CARS] WHERE ([FDATE] = @FDATE)">
                    <SelectParameters>
                        <asp:SessionParameter DbType="Date" Name="FDATE" SessionField="Date" />
                    </SelectParameters>
                </asp:SqlDataSource>
                <br /></td>
        </tr>
